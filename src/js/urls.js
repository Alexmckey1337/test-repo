...
const URLS = {
    ...
    users_birthdays: (day) => `/api/v1.0/notifications/birthdays/?from_date=${day}&to_date=${day}`,
    users_repentance_days: (day) => `/api/v1.0/notifications/repentance/?from_date=${day}&to_date=${day}`,
