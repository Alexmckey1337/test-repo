...
const SUMMIT = {
    ...
    send_schedules: (summitId) => `/api/v1.0/summit/${summitId}/send_unsent_schedules/`,
...
const URLS = {
    ...
    users_birthdays: () => `/api/v1.0/notifications/birthdays/`,
    users_repentance_days: () => `/api/v1.0/notifications/repentance/`,
