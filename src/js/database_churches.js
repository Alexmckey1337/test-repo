...
import {deleteData} from "./modules/Ajax";
import {createChurchesTable, clearAddChurchData, saveChurches, addChurch} from './modules/Church';
import {makePastorList} from './modules/MakeList';
import updateSettings from './modules/UpdateSettings';
import exportTableData from './modules/Export';
import {showAlert, showConfirm} from "./modules/ShowNotifications";
import {applyFilter, refreshFilter} from "./modules/Filter";
import parseUrlQuery from './modules/ParseUrl';
import {getLocationDB} from "./modules/Location";
import {getFilterParam} from "./modules/Filter";
import getSearch from './modules/Search';
import addQueryParam from './modules/addQueryParam';
...
//    Events
	...
	document.querySelector('#map_button').addEventListener('click', () => {
		let filter = {...getFilterParam(), ...getSearch('search_title')},
			link = addQueryParam('/map/churches/', filter);
		window.open(link, 'Churches_on_map');
	})
