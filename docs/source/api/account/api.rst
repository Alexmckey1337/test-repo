...
.. http:post:: /api/v1.1/users/(int:user_id)/set_divisions/

    Set new divisions list of user.
    If ``divisions = []`` => delete all divisions of user

    **Example request**:

    .. sourcecode:: http

        POST /api/v1.1/users/1/set_divisions/ HTTP/1.1
        Host: vocrm.org
        Accept: application/json
    ...
    **Example response**:
    ...
    .. sourcecode:: http
        ...
        {
          "detail": "Divisions list has been updated."
        }
    ...
    **Example response (Bad request 2)**:
    ...
    .. sourcecode:: http
        ...
        Content-Type: application/json
          ...
          [
            "Field 'divisions' is required."
          ]

    :form divisions: list of divisions ids
    :statuscode 200: divisions list updated
    :statuscode 400: bad request

Create partner
~~~~~~~~~~~~~~

.. http:post:: /api/v1.1/users/(int:user_id)/create_partner/

    Create Partner model for user with ``id = user_id``

    **Example request**:

    .. sourcecode:: http

        POST /api/v1.1/users/1/create_partner/ HTTP/1.1
        Host: vocrm.org
        Accept: application/json
    ...
    **Example response (partner is exist)**:
    ...
    .. sourcecode:: http
        ...
        [
          "Partner is already exist."
        ]

    **Example response (incorrect data)**:
    ...
    :form value: sum of partner's contribution
        :form date: date when the user became a partner
        :form responsible: responsible of partner
        :form currency: currency of partner

        :statuscode 201: partner created
        :statuscode 400: partner is exist or other bad request

Update partner
~~~~~~~~~~~~~~

.. http:post:: /api/v1.1/users/(int:user_id)/update_partner/

    Update partner for user with ``id = user_id``

    **Example request**:

    .. sourcecode:: http

        POST /api/v1.1/users/1/update_partner/ HTTP/1.1
        Host: vocrm.org
        Accept: application/json
    ...
    **Example response (partner does not exist)**:
