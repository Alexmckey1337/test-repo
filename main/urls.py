...
partner_patterns = [
    ...
    url(r'^summary/$', views.PartnerListSummaryView.as_view(), name='partnership_summary'),
    url(r'^summary/(?P<manager_id>\d+)/$', views.PartnerDetailSummaryView.as_view(), name='partnership_summary'),
]
