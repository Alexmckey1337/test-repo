...
class DealQuerySet(models.query.QuerySet):
    ...
    def annotate_responsible_name(self, alias='responsible_name'):
        return self.annotate(
            **{alias: Concat(
...
class DealManager(models.Manager):
    ...
    def annotate_responsible_name(self, alias='responsible_name'):
        return self.get_queryset().annotate_responsible_name(alias=alias)
...
class ChurchDealQuerySet(models.query.QuerySet):
    ...
    def annotate_full_name(self, alias='full_name'):
        return self.annotate(
            **{alias: F('partnership__church__title')})
